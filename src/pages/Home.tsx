  ...
  return (
    <>
      ...
      <p className="subtitle">
        passionate about tech, chess and muay thai. i enjoy building for myself
        and others.
      </p>

      <p className="note">this domain also hosts my personal software.</p>
      ...
      <nav className="links">
        ...
        <a
          href="https://farcaster.xyz/leal.eth"
          target="_blank"
          rel="noopener noreferrer"
        >
          farcaster
      ...
      <div
        className={`easter-egg ${showEasterEgg ? "show" : ""}`}
        id="easter-egg"
      >
